package io.techministry.android.fmc.app;
...
public class SampleActivity extends AppCompatActivity {
    ...
    ViewPager pager;
    private String[] titles = new String[]{"About Us", "Notifications", "Stay Connected", "Calendar"
            , "Location", "Sample Tab 6", "Sample Tab 7", "Sample Tab 8"};
